function script_plotResultsAsAveragePerRegionInAtlas_separateFigs(dirGralResults, MRIDirectory, strDate, posFixDir)
...
dirImages = [dirGralResults, filesep,'plotsLOCpaper_Neuron2023',filesep,'plotsMeanOnAtlas_',num2str(thVal),'to',num2str(maxVal),'_',date,posFixDir]; %MaxAt05'];
 ...
 %   figure('Name', [titNameFig,VarNames{iVar}], 'Position',[1 1 scrsz(3) scrsz(4)]);
    ...
    for iSheet=1:nCompPlots
      ...
      %  subplot(2,nCompPlots,iSheet); % top row
        figure('Name', [titNameFig,VarNames{iVar},SheetList{iSheet}], 'Position',[1 1 scrsz(3) scrsz(4)]);
        ...
        print(gcf,'-dpng','-r300',[dirImages, filesep,'RecElect', titNameFig,'_',VarNames{iVar},'_',SheetList{iSheet}])
        saveas(gcf,[dirImages,filesep, 'RecElect',titNameFig,'_',VarNames{iVar},'_',SheetList{iSheet},'.fig'])
      ...
      %  subplot(2,nCompPlots,iSheet+nCompPlots); % bottom row
        ...
        plotValuesOnAtlasBrain(plotVar, anatLocationsToGroup, titName, CategorySubcortStr, FaceLabelSubcort, VertexLabelSubcort, COLVar, valSteps, faceAlphaVal);
        print(gcf,'-dpng','-r300',[dirImages, filesep,'RecElect', titNameFig,'_',VarNames{iVar},'_',SheetList{iSheet},'_subCort'])
        saveas(gcf,[dirImages,filesep, 'RecElect',titNameFig,'_',VarNames{iVar},'_',SheetList{iSheet},'_subCort','.fig'])
    end
...
colWith1Feat = 6; % which column has the first feature - corresponds to condColFeat{1}
nCompPlots =length(SheetList);
...
%    figure('Name', [titNameFig], 'Position',[1 1 scrsz(3) scrsz(4)]);
    ...
    for iSheet=1:nCompPlots
        ...
        % Plot Left, Right and subcortical together
      %  subplot(2,nCompPlots,iSheet); % top row
        figure('Name', [titNameFig,featName,SheetList{iSheet}], 'Position',[1 1 scrsz(3) scrsz(4)]);
        plotValuesOnAtlasBrain(plotVar, anatLocationsToGroup, titName, CategoryLeftStr, FaceLabelLeft, VertexLabelLeft, COLVar, valSteps, faceAlphaVal);
        plotValuesOnAtlasBrain(plotVar, anatLocationsToGroup, titName, CategoryRightStr, FaceLabelRight, VertexLabelRight, COLVar, valSteps, faceAlphaVal);
        plotValuesOnAtlasBrain(plotVar, anatLocationsToGroup, titName, CategorySubcortStr, FaceLabelSubcort, VertexLabelSubcort, COLVar, valSteps, faceAlphaVal);
        print(gcf,'-dpng','-r300',[dirImages, filesep,'RecElect', titNameFig,'_',featName,'_',SheetList{iSheet}])
        saveas(gcf,[dirImages,filesep, 'RecElect',titNameFig,'_',featName,'_',SheetList{iSheet},'.fig'])
    ...
    %    subplot(2,nCompPlots,iSheet+nCompPlots); % bottom row
        ...
        plotValuesOnAtlasBrain(plotVar, anatLocationsToGroup, titName, CategoryLeftStr, FaceLabelLeft, VertexLabelLeft, COLVar, valSteps, faceAlphaValBkg);
        plotValuesOnAtlasBrain(plotVar, anatLocationsToGroup, titName, CategorySubcortStr, FaceLabelSubcort, VertexLabelSubcort, COLVar, valSteps, faceAlphaVal);
        print(gcf,'-dpng','-r300',[dirImages, filesep,'RecElect', titNameFig,'_',featName,'_',SheetList{iSheet},'_subC'])
        saveas(gcf,[dirImages,filesep, 'RecElect',titNameFig,'_',featName,'_',SheetList{iSheet},'_subC','.fig'])
    end
 ...
 %   figure('Name', [titNameFig], 'Position',[1 1 scrsz(3) scrsz(4)]);
   ...
   %     subplot(2,nCompPlots,iSheet); % top row
     ...
     %   subplot(2,nCompPlots,iSheet+nCompPlots); % bottom row
        ...
        plotValuesOnAtlasBrain(plotVar, anatLocationsToGroup, titName, CategoryLeftStr, FaceLabelLeft, VertexLabelLeft, COLVar, valSteps, faceAlphaValBkg);
        plotValuesOnAtlasBrain(plotVar, anatLocationsToGroup, titName, CategorySubcortStr, FaceLabelSubcort, VertexLabelSubcort, COLVar, valSteps, faceAlphaVal);
        print(gcf,'-dpng','-r300',[dirImages, filesep,'RecElect', titNameFig,'_',featName,'_',SheetList{iSheet},'_subCort'])
        saveas(gcf,[dirImages,filesep, 'RecElect',titNameFig,'_',featName,'_',SheetList{iSheet},'_subCort','.fig'])
    end
...
firstRow=3;
colWithAnat = 4; % which column has the anatomical information
colWith1Feat = 5; % which column has the first feature - corresponds to condColCent{1}
nCompPlots =length(SheetList);
...
%        subplot(2,nCompPlots,iSheet); % top row
        ...
        plotValuesOnAtlasBrain(plotVar, anatLocationsToGroup, titName, CategoryRightStr, FaceLabelRight, VertexLabelRight, COLVar, valSteps, faceAlphaVal);
        plotValuesOnAtlasBrain(plotVar, anatLocationsToGroup, titName, CategorySubcortStr, FaceLabelSubcort, VertexLabelSubcort, COLVar, valSteps, faceAlphaVal);
        print(gcf,'-dpng','-r300',[dirImages, filesep,'StimElect', titNameFig,'_',measNames{iFeat},'_',SheetList{iSheet}])
        saveas(gcf,[dirImages,filesep, 'StimElect',titNameFig,'_',measNames{iFeat},'_',SheetList{iSheet},'.fig'])
 ...
 %       subplot(2,nCompPlots,iSheet+nCompPlots); % bottom row
        ...
        plotValuesOnAtlasBrain(plotVar, anatLocationsToGroup, titName, CategoryLeftStr, FaceLabelLeft, VertexLabelLeft, COLVar, valSteps, faceAlphaValBkg);
        plotValuesOnAtlasBrain(plotVar, anatLocationsToGroup, titName, CategorySubcortStr, FaceLabelSubcort, VertexLabelSubcort, COLVar, valSteps, faceAlphaVal);
        print(gcf,'-dpng','-r300',[dirImages, filesep,'StimElect', titNameFig,'_',measNames{iFeat},'_',SheetList{iSheet},'_subCort'])
        saveas(gcf,[dirImages,filesep, 'StimElect',titNameFig,'_',measNames{iFeat},'_',SheetList{iSheet},'_subCort','.fig'])
    end
