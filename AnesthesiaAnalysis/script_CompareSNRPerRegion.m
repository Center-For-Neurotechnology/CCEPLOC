function  script_CompareSNRPerRegion(dirResultsVar, pNames, cfgStats, posFixFile)
% Statistical Comparison of SNR for paper CCEP LOC brain states
% based on Variability comparison - might have useless vconfig options
...
%% Variability file
% Results
pooledVariabilityFileName = [dirResultsVar,filesep,'pooledSNR',posFixFile,'.mat'];
...
parfor iRegFor=1:numel(posRegionFor)
    ...
    compareSNRPerStatePerRegion(pooledVariabilityFileName, dirResults, cfgStatsThisLoop)
end
